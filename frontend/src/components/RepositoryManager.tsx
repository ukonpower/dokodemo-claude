          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {repositories.map((repo) => (
              <div
                ...
                } ${isSwitchingRepo ? 'pointer-events-none opacity-50' : ''}`}
                onClick={() => !isSwitchingRepo && onSwitchRepository(repo.path)}
              >
                ...
                {/* ローディングオーバーレイ */}
                {isSwitchingRepo && (
                  <div className="absolute inset-0 bg-gray-900 bg-opacity-70 rounded-lg flex items-center justify-center">
