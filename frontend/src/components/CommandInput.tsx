...
const CommandInput = forwardRef<CommandInputRef, CommandInputProps>(({ onSendCommand, onSendArrowKey, onSendInterrupt, onSendEscape, onClearClaude, onChangeModel, disabled = false }, ref) => {
