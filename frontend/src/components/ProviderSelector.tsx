  ...
  return (
    <div className="flex items-center space-x-2">
      <select
        ...
        disabled={disabled}
        className="px-2 py-1 sm:px-3 sm:py-1.5 bg-dark-bg-secondary border border-dark-border-light rounded-lg text-xs sm:text-sm text-dark-text-primary focus:outline-none focus:ring-1 focus:ring-dark-accent-blue focus:border-dark-accent-blue hover:bg-dark-bg-hover hover:border-dark-border-focus disabled:bg-gray-600 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-150 shadow-md font-medium"
        title={
          disabled
            ? 'リポジトリを選択してからプロバイダーを変更してください'
            : ''
        }
      >
