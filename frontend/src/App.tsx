  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="border-l border-gray-300 pl-4">
                ...
                <p className="text-xs text-gray-500 truncate max-w-96">{currentRepo}</p>
              </div>
            </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 flex flex-col space-y-6">
        ...
        {/* ターミナルエリア */}
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 flex-1 min-h-0 flex flex-col">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-lg">
            <h2 className="text-base font-semibold text-gray-900 flex items-center">
